...
public class MainActivity extends AppCompatActivity {
    ...
    private final String ATRIBUTE_NAME_TEXT = "text";
    private final String ATRIBUTE_NAME_VALUE = "value";
    private final String ATRIBUTE_NAME_IMAGE = "image";

    private final int positive = R.drawable.ic_expand_less_black_24dp;
    private final int negative = R.drawable.ic_expand_more_black_24dp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            m.put(ATRIBUTE_NAME_TEXT, "Day " + (i + 1));
            m.put(ATRIBUTE_NAME_VALUE, values[i]);
            if (values[i] == 0) img = 0;
             else
            ...
            String[] from = {ATRIBUTE_NAME_TEXT, ATRIBUTE_NAME_VALUE, ATRIBUTE_NAME_IMAGE};
